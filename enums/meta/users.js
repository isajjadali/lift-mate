...
export const CustomerMeta = {
  ...
  sysEntity: SysEntities.customers,
...
export const DriverMeta = {
  ...
  backendPath: "/users",
  imgUrl: "/drivers.svg",
  sysEntity: SysEntities.drivers,
  description:
    "Users can search, create, edit, or remove driver profiles and see a full listing of drivers. It streamlines driver data management and updates.",
