        ...
        >
          <v-row align-center>
            <v-col cols="11" sm="10" md="8" class="image-text">
              ...
              <h3 class="text-white">
                Airport Sedan, Shuttle and Limo Service.
              </h3>
              <p
                class="text-white"
            ...
            <v-card class="pa-10">
              ...
              <v-row justify="center">
                <v-col cols="12" sm="6">
                  <div align="center">
                    <p
                      v-dompurify-html="homeConfig.serviceWeOfferDescription"
                    />
                  </div>
                </v-col>
              </v-row>
              ...
              <v-row class="mt-3">
                <v-col class="d-flex justify-center align-center">
                  ...
                  >
                    <v-card-text align="center">
                      <v-img
                        src="https://[-[bucket-name]-].s3.amazonaws.com/paypal.png"
                        lazy-src="https://[-[bucket-name]-].s3.amazonaws.com/paypal-lazy-src.png"
                      />
                    </v-card-text>
                  </v-card>
                </v-col>
                <v-col class="d-flex justify-center align-center">
                  ...
                  >
                    <v-img
                      src="https://[-[bucket-name]-].s3.amazonaws.com/ssl.png"
                      lazy-src="https://[-[bucket-name]-].s3.amazonaws.com/ssl-lazy-src.png"
                    />
                  </v-card>
                </v-col>
              </v-row>
  ...
  computed: {
    ...
    items() {
      return [
        ...
        return {
          src: `${this.s3Url}${item.src}`,
          lazySrc: `${this.s3Url}${item.lazySrc}`,
        };
      });
    },
    homeConfig() {
