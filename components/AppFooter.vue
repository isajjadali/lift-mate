<template>
  <v-footer>
    ...
    >
      ...
      >
        <div class="w-75">
          <h1 class="app-name text-uppercase">Lift Mate</h1>

          <p class="mt-5 text-white">
            Rent high-quality SUVs, for fun vacation or road trip
          </p>
        </div>
      </v-col>
      ...
      >
        ...
        <div
          :class="{
            'd-flex justify-space-between flex-wrap mt-2': $vuetify.display.xs,
            'mt-5': $vuetify.display.smAndUp,
          }"
        >
      ...
      <v-col
        ...
        class="mt-5"
      >
        <v-divider color="grey-lighten-4" />
      </v-col>
